...
annot = fread("/BIGDATA2/scau_hzhang_1/USER/tengjy/Pig_GTEx_enhancer/data/enhancer.saf")
...
for (i in 1:34){
    ...
    esi = fread("/BIGDATA2/scau_hzhang_1/USER/tengjy/Pig_GTEx_GWAS_and_eQTLs/SMR/PreDATA/BESD_file_enhancer/" %&% tis %&% ".enqtl_allpairs.esi.old")
    epi = fread("/BIGDATA2/scau_hzhang_1/USER/tengjy/Pig_GTEx_GWAS_and_eQTLs/SMR/PreDATA/BESD_file_enhancer/" %&% tis %&% ".enqtl_allpairs.epi.old")
    ...
    fwrite(esi,"/BIGDATA2/scau_hzhang_1/USER/tengjy/Pig_GTEx_GWAS_and_eQTLs/SMR/PreDATA/BESD_file_enhancer/" %&% tis %&% ".enqtl_allpairs.esi", col.names=F, sep = "\t")
    ...
    epi$V5 = epi$V2
    fwrite(epi,"/BIGDATA2/scau_hzhang_1/USER/tengjy/Pig_GTEx_GWAS_and_eQTLs/SMR/PreDATA/BESD_file_enhancer/" %&% tis %&% ".enqtl_allpairs.epi", col.names=F, sep = "\t")
}
